...
def _make_coordinator(mock_hass, mock_config_entry, mode=MODE_MORNING_DISCHARGE):
    ...
    with patch.object(InverterChargeNightCoordinator, "__init__", lambda self, *a, **kw: None):
        ...
        coord._adhoc_until = None
        coord._adhoc_reason = None
        coord._adhoc_target_soc = None
        coord._adhoc_allow_grid_charge = False
        coord._rescue_stage = 0
        coord.evening_rescue_charge = False
